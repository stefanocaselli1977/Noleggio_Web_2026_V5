...
// PASTLWTR : 1.2
// File generated on 9/15/2014 9:58:45 AM from Type Library described below.
...
function TMailProperties.Get_PIPELINING: Integer;
begin
    Result := DefaultInterface.PIPELINING;
end;

procedure TMailProperties.Set_PIPELINING(pVal: Integer);
begin
  DefaultInterface.Set_PIPELINING(pVal);
end;
